import{_ as o,c as l,o as p,a,b as s,d as n}from"./app.a496e31a.js";const R=JSON.parse('{"title":"沿着Path进行动画","description":"","frontmatter":{"title":"沿着Path进行动画"},"headers":[{"level":2,"title":"使用 path 特性指定运动轨迹","slug":"使用-path-特性指定运动轨迹","link":"#使用-path-特性指定运动轨迹","children":[]},{"level":2,"title":"使用mpath 元素引用路径","slug":"使用mpath-元素引用路径","link":"#使用mpath-元素引用路径","children":[]},{"level":2,"title":"animtionMotion 特性优先级","slug":"animtionmotion-特性优先级","link":"#animtionmotion-特性优先级","children":[]},{"level":2,"title":"⭐ 元素沿着路径的旋转方向 - rotate","slug":"⭐-元素沿着路径的旋转方向-rotate","link":"#⭐-元素沿着路径的旋转方向-rotate","children":[]},{"level":2,"title":"使用keyPoints控制路径动画的动画距离","slug":"使用keypoints控制路径动画的动画距离","link":"#使用keypoints控制路径动画的动画距离","children":[]},{"level":2,"title":"⭐ 文本路径动画 - startOffset","slug":"⭐-文本路径动画-startoffset","link":"#⭐-文本路径动画-startoffset","children":[]}],"relativePath":"svg/animation/svg-animation-motion-path.md","lastUpdated":1673434777000}'),e={name:"svg/animation/svg-animation-motion-path.md"},t=a("",7),c=s("iframe",{height:"300",style:{width:"100%"},scrolling:"no",title:"Untitled",src:"https://codepen.io/JamesSawyer/embed/preview/qBKXEwM?default-tab=result&editable=true&theme-id=dark",frameborder:"no",loading:"lazy",allowtransparency:"true",allowfullscreen:"true"},`
